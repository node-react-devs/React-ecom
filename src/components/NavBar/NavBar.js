...
import { Flex, Heading,  Box, Spacer,Img,Input,InputGroup,InputRightElement} from '@chakra-ui/react'
...
const NavBar = () => {
  ...
  React.useEffect(
      ()=>{
        const doShad=()=>{setTimeout(()=>setShad(window.scrollY),100)}
  ...
  <Box width='100%' mb='100'>
   ...
   <Box bgGradient="linear(to-l,gray.200, white )"  color='blackAlpha.900' pos='fixed' top={'0'} width='100%' zIndex='2'  transition='all ease-in-out 0.5s'>
